...
// 17b - there are several fixed shapes of pieces made of rock which can fall
...
//
//       part b, did we say 2022 pieces? we meant 1000000000000.
//
// idea: simulation of the game, but track state and figure where the state repeats.
//       then we can figure out how many full cycles would happen in the given
//       time frame and compute the height it would add. then we simulate the final
//       incomplete cycle.
//
